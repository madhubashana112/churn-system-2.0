...
CANONICAL_ROLES = ("CUSTOMER_ID", "TIMESTAMP", "TRANSACTION_AMOUNT", "STATUS", "EVENT_TYPE", "SUBSCRIPTION_PLAN", "USAGE_ACTIVITY", "TEXT", "ATTRIBUTE", "NOISE_IGNORE", "CUSTOM", "UNKNOWN")
...
CANONICAL_NAMES = {"CUSTOMER_ID": "customer_id", "TIMESTAMP": "timestamp",
    "TRANSACTION_AMOUNT": "transaction_amount", "STATUS": "status", "EVENT_TYPE": "event_type", "TEXT": "text", "SUBSCRIPTION_PLAN": "plan_tier", "USAGE_ACTIVITY": "usage_activity"}
